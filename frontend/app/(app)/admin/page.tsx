...
type CloserRow = { id: string; nome: string; email: string; ativo: boolean; isAdmin: boolean };
...
export default async function AdminPage() {
  ...
  const { ok, data } = await apiServerJson<{ closers: CloserRow[]; clientes: ClienteProgresso[] }>(
    "/api/views/admin",
  );

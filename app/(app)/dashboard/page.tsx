...
export default async function DashboardPage() {
  ...
  const [closers, clientes] = await Promise.all([
    // Só closers ativos (e não-gestores) aparecem no dashboard e na apresentação.
    prisma.closer.findMany({ where: { ativo: true, isAdmin: false }, orderBy: { nome: "asc" } }),
